...
// C_layoutNetwork
arma::mat C_layoutNetwork(arma::sp_mat& G, arma::mat& initial_coordinates, std::string method, unsigned int n_components, float spread, float min_dist, unsigned int n_epochs, float learning_rate, float repulsion_strength, float negative_sample_rate, bool approx_pow, bool pcg_rand, std::string rng_type, bool batch, unsigned int grain_size, Rcpp::NumericVector ai, Rcpp::NumericVector aj, int seed, int thread_no, bool verbose, float a, float b, std::string opt_method, float alpha, float beta1, float beta2, float eps, bool repair_disconnected);
RcppExport SEXP _actionet_C_layoutNetwork(SEXP GSEXP, SEXP initial_coordinatesSEXP, SEXP methodSEXP, SEXP n_componentsSEXP, SEXP spreadSEXP, SEXP min_distSEXP, SEXP n_epochsSEXP, SEXP learning_rateSEXP, SEXP repulsion_strengthSEXP, SEXP negative_sample_rateSEXP, SEXP approx_powSEXP, SEXP pcg_randSEXP, SEXP rng_typeSEXP, SEXP batchSEXP, SEXP grain_sizeSEXP, SEXP aiSEXP, SEXP ajSEXP, SEXP seedSEXP, SEXP thread_noSEXP, SEXP verboseSEXP, SEXP aSEXP, SEXP bSEXP, SEXP opt_methodSEXP, SEXP alphaSEXP, SEXP beta1SEXP, SEXP beta2SEXP, SEXP epsSEXP, SEXP repair_disconnectedSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::sp_mat& >::type G(GSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type repair_disconnected(repair_disconnectedSEXP);
    rcpp_result_gen = Rcpp::wrap(C_layoutNetwork(G, initial_coordinates, method, n_components, spread, min_dist, n_epochs, learning_rate, repulsion_strength, negative_sample_rate, approx_pow, pcg_rand, rng_type, batch, grain_size, ai, aj, seed, thread_no, verbose, a, b, opt_method, alpha, beta1, beta2, eps, repair_disconnected));
    return rcpp_result_gen;
END_RCPP
}
// C_computeNodeColors
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_actionet_C_layoutNetwork", (DL_FUNC) &_actionet_C_layoutNetwork, 28},
