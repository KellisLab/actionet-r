...
#' @param color_slot Name of entry in colMaps(data) containing RGB values for default point colors generated by 'layout_ACTIONet()'. Used only if no other coloring parameters are given or valid (default:'colors_actionet').
...
#' @param scale_coors Scale and center plot coordinates. (default:'TRUE')
#' @param color_slot Name of entry in colMaps(ace) containing RGB values for default point colors generated by 'layout_ACTIONet()'. Used only if no other coloring parameters are given or valid. (default:'colors_actionet')
#' @param point_order Integer vector specifying order in which to plot individual points. (default:'NULL')
